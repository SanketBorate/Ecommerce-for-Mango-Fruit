            ...
            <div>
                ...
                <Container>
                    ...
                    <Form.Group className="mb-6" controlId="formGroupPassword">
                        ...
                        <Form.Control type="text" name="fname" onChange={this.handleChange} placeholder="Enter First Name" />
                    </Form.Group>
                    <Form.Group className="mb-6" controlId="formGroupPassword">
                        <Form.Label>Last Name</Form.Label>
                        <Form.Control type="text" name="lname" onChange={this.handleChange} placeholder="Enter Last Name" />
                    </Form.Group>
                    <Form.Group className="mb-6" controlId="formGroupPassword">
                        <Form.Label>Contact Number</Form.Label>
                        <Form.Control type="text" name="contactNo" onChange={this.handleChange} placeholder="Enter Contact Number" />
                    </Form.Group><br/>
                    {/* <Form.Group className="mb-6" controlId="formGroupPassword">
